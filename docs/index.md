...
description: Use clang directly. Input and print streaming char i/o to <div> tag, use <canvas> tag as a terminal, use 2D C/C++ drawing API, run blocking C/C++ code.
---

# Learn WebAssembly with twr-wasm<br>Documentation and Examples

 <img src="./img/twr-wsm-ascii.png" width="45%">                                        
