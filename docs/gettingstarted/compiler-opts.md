...
This section describes how to use `clang` to compile C/C++ code for WebAssembly, and how to use `clang` to link your files into a .wasm module, when using twr-wasm.
